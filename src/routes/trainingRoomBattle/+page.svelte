    ...
    async function createGameScene() {
        ...
        return class CardGameScene extends Phaser.Scene {
            ...
            createCharacter(x, y, team, position) {
                ...
                const barWidth = characterImage.displayWidth;
                const barHeight = 20;
            ...
            highlightCharacter(character,attribute) {
                ...
                const moveAmount = container.y < 360 ? 50 : -50; // 360 is half of 720
                        ...
                        try {
                            ...
                            if (container) {
                                ...
                                if (characterImage) {
                                    ...
                                    characterImage.setPosition(0, -cardHeight * 0.1);
                                    characterImage.setOrigin(0.5);
                                }
                            }
    ...
    async function createPreloadScene() {
        ...
        return class PreloadScene extends Phaser.Scene {
            ...
            preload() {
                ...
                // Load bot sprite sheets instead of NFT images for defenders
